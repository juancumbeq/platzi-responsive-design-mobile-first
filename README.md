...
```
The design is complete! Or is it? You have just finished working on all the sections, and the result is quite good on a mobile device, but only from there! We still have the media queries part left to adapt all the elements to different widths.
